...
int main()
{
	...
	mainLight = Light(1.0f, 1.0f, 1.0f, 0.2f, 
					2.0f, -1.0f, -2.0f, 1.0f); // added 4 random var
	...
	unsigned int uniformDiffuseIntensityLocation = 0; ///
	unsigned int uniformDirectionLocation = 0; ///
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//uniformAmbientDiffuseIntensityLocation = shaderList[0].
			//uniformdirectionLocation = 
